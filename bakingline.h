...
#define SILO1_TIME SCHEDULE_TICKS_PER_SECOND * 2
#define SILO2_TIME SCHEDULE_TICKS_PER_SECOND * 3
#define SILO3_TIME SCHEDULE_TICKS_PER_SECOND * 5
#define MIXING_TIME SCHEDULE_TICKS_PER_SECOND * 5
#define BAKING_TIME SCHEDULE_TICKS_PER_SECOND * 30
...
enum oven_states {
	IDLE_OVEN, WAIT_IN_OVEN, MOVE_IN_OVEN, BAKE_OVEN, MOVE_OUT_OVEN
};
